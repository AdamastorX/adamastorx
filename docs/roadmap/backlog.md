...
- Dependencies: none.
- Priority: P0 (raised from P2, ADR 0031, 2026-08-06). Labels: `documentation`. **Absorbed into M14 as its first item** — the 2026-08-06 review found the project's reputation goal is blocked on exactly this doc; it has now survived three milestones unbuilt, which is itself the finding. The M0-M5 scope above is stale: the doc covers M0-M13, one line per milestone.
